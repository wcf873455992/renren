	...
	methods: {
		...
		saveOrUpdate: function (event) {
		    $('#btnSaveOrUpdate').button('loading').delay(1000).queue(function() {
                var url = vm.garden.gardenId == null ? "api/garden/save" : "api/garden/update";
                $.ajax({
                    type: "POST",
                    url: baseURL + url,
		...
		getInfo: function(gardenId){
			$.get(baseURL + "api/garden/info/"+gardenId, function(r){
                vm.garden = r.garden;
            });
		},
